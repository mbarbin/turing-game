...
interactive solver, or if this is an indication of a bug somewhere.
  ...
  (Test_result
   ((code 114) (verifier 10) (result true)
  ...
  (Test_result
   ((code 114) (verifier 03) (result false) (remaining_bits_before 2)
  ...
  (Request_test
   ((new_round true) (code 131) (verifier 03)
    (info
     ((code 131) (verifier 03)
      (score_if_true
  ...
  Enter result for test. code="131" - verifier="03": 
  (Test_result
   ((code 131) (verifier 03) (result true)
  ...
  ((resolution_path
    ((rounds
      (((code 114) (verifiers (10 07 03))) ((code 131) (verifiers (03)))
