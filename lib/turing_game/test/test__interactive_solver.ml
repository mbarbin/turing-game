...
let%expect_test "interactive solver simulation decoder 20" =
  ...
  [%expect
    ...
    (Request_test
     ((new_round true) (code 334) (verifier_name 11)
      (info
       ((code 334) (verifier_name 11)
        (score_if_true
    ...
    (Test_result
     ((code 334) (verifier_letter A) (verifier_name 11)
      (condition ((index 0) (condition (Less_than (a Triangle) (b Square)))))
    ...
    (Request_test
     ((new_round false) (code 334) (verifier_name 22)
      (info
       ((code 334) (verifier_name 22)
        (score_if_true
    ...
    (Test_result
     ((code 334) (verifier_letter B) (verifier_name 22)
    ...
    (Request_test
     ((new_round false) (code 334) (verifier_name 34)
      (info
    ...
    (Test_result
     ((code 334) (verifier_letter E) (verifier_name 34)
      ...
      (number_of_remaining_codes 4)))
    (Request_test
     ((new_round true) (code 141) (verifier_name 30)
      (info
       ((code 141) (verifier_name 30)
        (score_if_true ((bits_gained 1) (probability 0.36363636363636365)))
        (score_if_false ((bits_gained 1) (probability 0.63636363636363635)))))))
    (Test_result
     ((code 141) (verifier_letter C) (verifier_name 30)
      (condition ((index 1) (condition (Equal_value (symbol Square) (value 4)))))
      (result true) (remaining_bits_before 2) (bits_gained 1) (remaining_bits 1)
      (number_of_remaining_codes 2)))
    (Request_test
     ((new_round false) (code 141) (verifier_name 33)
      (info
       ((code 141) (verifier_name 33)
        (score_if_true ((bits_gained 1) (probability 0.25)))
        (score_if_false ((bits_gained 1) (probability 0.75)))))))
    (Test_result
     ((code 141) (verifier_letter D) (verifier_name 33)
    ...
    (Info
     ((resolution_path
       ((rounds
         (((code 334) (verifiers (11 22 34))) ((code 141) (verifiers (30 33)))))))
    ...
    (Request_test
     ((new_round false) (code 141) (verifier_name 33)
      (info
       ((code 141) (verifier_name 33)
        (score_if_true ((bits_gained 1) (probability 0.42857142857142855)))
        (score_if_false ((bits_gained 0) (probability 0.5714285714285714)))))))
    (Test_result
     ((code 141) (verifier_letter D) (verifier_name 33)
      (condition ((index 0) (condition (Is_even (symbol Triangle)))))
      ...
      (number_of_remaining_codes 2)))
    (Request_test
     ((new_round false) (code 141) (verifier_name 40)
      (info
       ((code 141) (verifier_name 40)
        (score_if_true ((bits_gained 1) (probability 0.25)))
        (score_if_false ((bits_gained 0) (probability 0.75)))))))
    (Test_result
     ((code 141) (verifier_letter F) (verifier_name 40)
      (condition
       ((index 0) (condition (Less_than_value (symbol Triangle) (value 3)))))
      (result true) (remaining_bits_before 1) (bits_gained 1) (remaining_bits 0)
      (number_of_remaining_codes 1)))
    (Info
     ((resolution_path
       ((rounds
         (((code 334) (verifiers (11 22 34)))
          ((code 141) (verifiers (30 33 40)))))))
