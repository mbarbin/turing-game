...
let%expect_test "interactive solver simulation decoder 20" =
  ...
  [%expect
    ...
    (Request_test
     ((new_round true) (code 444) (verifier_name 11)
      (info
       ((code 444) (verifier_name 11)
        (score_if_true
    ...
    (Test_result
     ((code 444) (verifier_letter A) (verifier_name 11)
      (condition ((index 0) (condition (Less_than (a Triangle) (b Square)))))
    ...
    (Request_test
     ((new_round false) (code 444) (verifier_name 22)
      (info
       ((code 444) (verifier_name 22)
        (score_if_true
    ...
    (Test_result
     ((code 444) (verifier_letter B) (verifier_name 22)
    ...
    (Request_test
     ((new_round false) (code 444) (verifier_name 40)
      (info
       ((code 444) (verifier_name 40)
        (score_if_true
    ...
    (Test_result
     ((code 444) (verifier_letter F) (verifier_name 40)
      (condition
       ((index 0) (condition (Less_than_value (symbol Triangle) (value 3)))))
      (result false) (remaining_bits_before 3) (bits_gained 0) (remaining_bits 3)
      (number_of_remaining_codes 8)))
    (Request_test
     ((new_round true) (code 141) (verifier_name 11)
      (info
       ((code 141) (verifier_name 11)
        (score_if_true ((bits_gained 1) (probability 0.5)))
        (score_if_false ((bits_gained 1) (probability 0.5)))))))
    (Test_result
     ((code 141) (verifier_letter A) (verifier_name 11)
      (condition ((index 0) (condition (Less_than (a Triangle) (b Square)))))
      (result true) (remaining_bits_before 3) (bits_gained 1) (remaining_bits 2)
      (number_of_remaining_codes 4)))
    (Request_test
     ((new_round false) (code 141) (verifier_name 30)
      (info
    ...
    (Test_result
     ((code 141) (verifier_letter C) (verifier_name 30)
      ...
      (number_of_remaining_codes 2)))
    (Request_test
     ((new_round false) (code 141) (verifier_name 11)
      (info
       ((code 141) (verifier_name 11)
        (score_if_true ((bits_gained 1) (probability 0.5)))
        (score_if_false ((bits_gained 1) (probability 0.5)))))))
