  ...
  [%expect
    ...
    ((code 245)
     (verifiers
      (((name 11)
        (criteria ((index 0) (condition (Less_than (a Triangle) (b Square))))))
       ((name 22) (criteria ((index 0) (condition Are_increasing))))
       ((name 30)
        (criteria
         ((index 1) (condition (Equal_value (symbol Square) (value 4))))))
       ((name 33) (criteria ((index 0) (condition (Is_even (symbol Triangle))))))
       ((name 34)
        (criteria
         ((index 0)
    ...
    (Test_result
     ((code 121) (verifier 22) (condition ((index 0) (condition Are_increasing)))
      (result false) (remaining_bits_before 2) (bits_gained 2) (remaining_bits 0)
      (number_of_remaining_codes 1)))
    (Info
     ((resolution_path
       ((rounds
     ...
     (verifiers
      (((name 11)
       ...
       ((name 30)
        (criteria
         ((index 1) (condition (Equal_value (symbol Square) (value 4))))))
       ((name 33) (criteria ((index 1) (condition (Is_even (symbol Square))))))
       ((name 34)
        (criteria
         ((index 0)
          (condition (Is_smallest_or_equally_smallest (symbol Triangle))))))
     ...
     ((new_round false) (code 211) (verifier 22)
      (info
       ((code 211) (verifier 22)
        ...
        (score_if_false ((bits_gained 1) (probability 0.5)))))))
    (Test_result
     ((code 211) (verifier 22) (condition ((index 0) (condition Are_increasing)))
